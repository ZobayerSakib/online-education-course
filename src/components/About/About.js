...
const About = () => {
    ...
    return (
        <div className='container about-container mt-4'>
            ...
            <p>English Care Academy is an online english learning platform. We are providing many services since 2002 in Bangladesh. Our Online services has proved that this platform is working well and make a good impact in students career.
                <br />
                <br />
